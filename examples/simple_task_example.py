...
async def simple_task_example():
    ...
    # 4. 定义用户目标
    user_goal = """
    我正在学习 apache SkyWalking, 请帮助我生成一个大概两个月学习周期的计划
    """
...
async def advanced_example_with_monitoring():
    ...
    llm_client = OpenAICompatibleClient(api_key=api_key, base_url="https://api.deepseek.com")
...
async def example_with_error_recovery():
    ...
    # 2. 配置启用错误恢复
    config = MiniAimeConfig(enable_auto_recovery=True, max_parallel_agents=2)
